...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Количество призывников: " + familiesOfConscripts.size());
        System.out.println("Количество потенциально работоспособных людей: " + workablePeople.size());
    }
}